...
export class CollaboratorController {
    ...
    async getCollaboratorByUserId(
        ...
        const collaborators =
            await this.collaboratorService.getCollaboratorByUserId(
                boardId,
                userId,
            );
        return { collaborators };
    ...
    async addCollaborator(@Body() dto: Omit<Collaborator, '_id'>) {
        const collaborator =
            await this.collaboratorService.addCollaborator(dto);
    ...
    async updateCollaboratorRole(
        ...
        const collaborator =
            await this.collaboratorService.updateCollaboratorRole(
                boardId,
                userId,
                role,
            );
